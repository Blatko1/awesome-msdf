...
float thickness = -0.4; // Range: -0.3 < thickness < 0.3
//float outline1Thickness = 0.4; // Range: 0.0 < outlineThickness < 0.4
//float outline2Thickness = 0.2; // Range: 0.0 < outlineThickness < 0.4
